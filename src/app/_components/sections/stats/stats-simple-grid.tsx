        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              >
                Engineering the Future: Bet on Innovation
              </h2>
              <p
              ...
              >
                Join the revolution with Gamble, where cutting-edge engineering and development meet extraordinary possibilities. Let's create something incredible, together.
              </p>
            </div>
            <dl
